...
class TwitchCategoryServiceTest {
    ...
    @InjectMocks private TwitchCategoryServiceImpl service;
    ...
    void setup() {
        ...
        ReflectionTestUtils.setField(service, "prewarmMode", TwitchCategoryServiceImpl.PrewarmMode.TOP);
    }
    ...
    void searchCategories_returnEmptyWhenLiveUnavailableAndCacheMiss() {
        ...
        List<TwitchCategory> results = service.searchCategories("anything");
    ...
    void prewarmCategoryCache_skipsWhenModeIsNone() {
        ReflectionTestUtils.setField(service, "prewarmMode", TwitchCategoryServiceImpl.PrewarmMode.NONE);
    ...
    void prewarmCategoryCache_sweepStartsFromMaxKnownId() {
        ReflectionTestUtils.setField(service, "prewarmMode", TwitchCategoryServiceImpl.PrewarmMode.SWEEP);
    ...
    void prewarmCategoryCache_bothModeCallsTopGamesThenSweep() {
        ReflectionTestUtils.setField(service, "prewarmMode", TwitchCategoryServiceImpl.PrewarmMode.BOTH);
