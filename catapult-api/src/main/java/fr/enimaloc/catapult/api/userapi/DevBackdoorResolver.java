...
public class DevBackdoorResolver {
     ...
     * (type, sourceId) pair — used to turn a real game binding into a "try it out"-able Swagger
     * example (see ApiChannelDataController). Only STEAM (plain decimal appId) and XBOX (base36
     * product id) round-trip through this scheme; BATTLENET/MANUAL/MINECRAFT don't have a nibble
     * assigned at all, and any sourceId that doesn't parse for its type is also rejected.
     */
